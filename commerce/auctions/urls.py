...
urlpatterns = [
    ...
    path("listings/<str:title>/watchlist/add", views.watchlist_add, name="add_watchlist"),
    path("listings/<str:title>/watchlist/remove", views.watchlist_remove, name="remove_watchlist")
]
